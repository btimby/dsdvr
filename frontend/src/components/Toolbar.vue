<template>
  <nav>
    <v-toolbar app dark>
      <v-toolbar-side-icon
        @click.stop="local.drawer = !local.drawer">
      </v-toolbar-side-icon>
      <v-toolbar-title class="hadline">
        <span class="grey--text">ds</span><span>DVR</span>
      </v-toolbar-title>
      <v-spacer></v-spacer>
    ...
    <v-navigation-drawer v-model="local.drawer" app dark>
      <v-list class="pa-1">
        <v-list-tile avatar>
          <v-list-tile-avatar>
        ...
        <div v-for="item in local.menu" :key="item.id">
          ...
          <v-list-tile v-for="subitem in item.items" :key="subitem.id" router :to="subitem.route">
            <v-list-tile-action>
