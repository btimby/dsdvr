...
class TaskGuideImport(BaseTask):
    ...
    <tv>
        ...
        ...
        <programme start="20190126210000 -0500" stop="20190127000000 -0500" channel="I1.27753.zap2it.com">
                <title lang="en">iN Demand Previews</title>
                <length units="minutes">180</length>
                <icon src="https://zap2it.tmsimg.com/assets/p1008134_st_v8_aa.jpg" />
                <url>https://tvlistings.zap2it.com//overview.html?programSeriesId=SH00377721&amp;tmsId=SH003777210000</url>
                <episode-num system="dd_progid">SH00377721.0000</episode-num>
                <previously-shown />
        </programme>
        ...
    </tv>
